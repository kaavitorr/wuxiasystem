...
DND5E.abilities = {
  str: {
    ...
    icon: "systems/wuxia-system/icons/svg/abilities/strength.svg"
  },
  dex: {
    ...
    icon: "systems/wuxia-system/icons/svg/abilities/dexterity.svg"
  },
  con: {
    ...
    icon: "systems/wuxia-system/icons/svg/abilities/constitution.svg"
  },
  int: {
    ...
    icon: "systems/wuxia-system/icons/svg/abilities/intelligence.svg",
    defaults: { vehicle: 0 }
  },
  wis: {
    ...
    icon: "systems/wuxia-system/icons/svg/abilities/wisdom.svg",
    defaults: { vehicle: 0 }
  },
  cha: {
    ...
    icon: "systems/wuxia-system/icons/svg/abilities/charisma.svg",
    defaults: { vehicle: 0 }
  },
  hon: {
...
DND5E.skills = {
  ...
  ath: {
    ...
    ability: "str",
    fullKey: "athletics",
    reference: "Compendium.wuxia-system.conteudo.JournalEntry.uKKV909xsw17EMmE.JournalEntryPage.E0HyftT4a8L8izrn",
  ...
  acr: {
    ...
    ability: "dex",
    fullKey: "acrobatics",
    reference: "Compendium.wuxia-system.conteudo.JournalEntry.uKKV909xsw17EMmE.JournalEntryPage.TBVH56FoQArmMSBs",
  ...
  ste: {
    ...
    ability: "dex",
    fullKey: "stealth",
    reference: "Compendium.wuxia-system.conteudo.JournalEntry.uKKV909xsw17EMmE.JournalEntryPage.rOZ9n5PYFuEbF08g",
  ...
  slt: {
    ...
    reference: "Compendium.wuxia-system.conteudo.JournalEntry.uKKV909xsw17EMmE.JournalEntryPage.Fe5nQhWyR8vmTdLC",
  ...
  sci: {
    ...
    ability: "wis",
    fullKey: "ciencia",
    reference: "Compendium.wuxia-system.conteudo.JournalEntry.uKKV909xsw17EMmE.JournalEntryPage.tWMttxGVytG2EL1R",
  ...
  his: {
    ...
    ability: "wis",
    fullKey: "history",
    reference: "Compendium.wuxia-system.conteudo.JournalEntry.uKKV909xsw17EMmE.JournalEntryPage.MjR2QOJE5LPKiN0F",
  ...
  inv: {
    ...
    reference: "Compendium.wuxia-system.conteudo.JournalEntry.uKKV909xsw17EMmE.JournalEntryPage.wLE08CcH5Zj8l1eS",
  ...
  med: {
    ...
    ability: "wis",
    fullKey: "medicine",
    reference: "Compendium.wuxia-system.conteudo.JournalEntry.uKKV909xsw17EMmE.JournalEntryPage.x9lTMRKUfHR7g9qN",
  ...
  nat: {
    ...
    ability: "wis",
    fullKey: "nature",
    reference: "Compendium.wuxia-system.conteudo.JournalEntry.uKKV909xsw17EMmE.JournalEntryPage.h9MaeejQSTgBF3BM",
  ...
  sur: {
    ...
    ability: "wis",
    fullKey: "survival",
    reference: "Compendium.wuxia-system.conteudo.JournalEntry.uKKV909xsw17EMmE.JournalEntryPage.ZKJhD4I3Pc75BNzF",
  ...
  nen: {
    ...
    ability: "int",
    fullKey: "nen",
    reference: "Compendium.wuxia-system.conteudo.JournalEntry.uKKV909xsw17EMmE.JournalEntryPage.mpq4YIaZuIwDQPiq",
  ...
  ins: {
    ...
    ability: "int",
    fullKey: "insight",
    reference: "Compendium.wuxia-system.conteudo.JournalEntry.uKKV909xsw17EMmE.JournalEntryPage.dJF7x8aruBfT84cz",
  ...
  prc: {
    ...
    ability: "int",
    fullKey: "perception",
    reference: "Compendium.wuxia-system.conteudo.JournalEntry.uKKV909xsw17EMmE.JournalEntryPage.elJZJXFWk7t0nf31",
  ...
  sob: {
    ...
    reference: "Compendium.wuxia-system.conteudo.JournalEntry.uKKV909xsw17EMmE.JournalEntryPage.04XZdF0Ntc60wj12",
  ...
  luc: {
    ...
    ability: "int",
    fullKey: "sorte",
    reference: "Compendium.wuxia-system.conteudo.JournalEntry.uKKV909xsw17EMmE.JournalEntryPage.mcIlW9Xizd3l3rtD",
  ...
  prf: {
    ...
    ability: "cha",
    fullKey: "performance",
    reference: "Compendium.wuxia-system.conteudo.JournalEntry.uKKV909xsw17EMmE.JournalEntryPage.cHdibPaupb34dyk4",
  ...
  dec: {
    ...
    ability: "cha",
    fullKey: "deception",
    reference: "Compendium.wuxia-system.conteudo.JournalEntry.uKKV909xsw17EMmE.JournalEntryPage.6eg3JWjY8xs6DMC6",
  ...
  itm: {
    ...
    reference: "Compendium.wuxia-system.conteudo.JournalEntry.uKKV909xsw17EMmE.JournalEntryPage.70xBRlUnlGDapKy6",
  ...
  per: {
    ...
    ability: "cha",
    fullKey: "persuasion",
    reference: "Compendium.wuxia-system.conteudo.JournalEntry.uKKV909xsw17EMmE.JournalEntryPage.vmdCFLdaRG729Yg9",
  ...
  pro: {
    ...
    ability: "cha",
    fullKey: "provocacao",
    reference: "Compendium.wuxia-system.conteudo.JournalEntry.uKKV909xsw17EMmE.JournalEntryPage.xLVLvUH9S8hfD1rY",
    icon: "icons/skills/social/intimidation-impressing.webp"
  }
};
...
DND5E.facilities = {
  ...
  orders: {
    build: {
      ...
      icon: "systems/wuxia-system/icons/svg/facilities/build.svg"
    },
    change: {
      label: "DND5E.FACILITY.Orders.change.inf",
      icon: "systems/wuxia-system/icons/svg/facilities/change.svg",
      duration: 21
    },
    craft: {
      label: "DND5E.FACILITY.Orders.craft.inf",
      icon: "systems/wuxia-system/icons/svg/facilities/craft.svg"
    },
    empower: {
      label: "DND5E.FACILITY.Orders.empower.inf",
      icon: "systems/wuxia-system/icons/svg/facilities/empower.svg"
    },
    enlarge: {
      label: "DND5E.FACILITY.Orders.enlarge.inf",
      icon: "systems/wuxia-system/icons/svg/facilities/enlarge.svg",
      basic: true
    },
    harvest: {
      label: "DND5E.FACILITY.Orders.harvest.inf",
      icon: "systems/wuxia-system/icons/svg/facilities/harvest.svg"
    },
    maintain: {
      label: "DND5E.FACILITY.Orders.maintain.inf",
      icon: "systems/wuxia-system/icons/svg/facilities/maintain.svg"
    },
    recruit: {
      label: "DND5E.FACILITY.Orders.recruit.inf",
      icon: "systems/wuxia-system/icons/svg/facilities/recruit.svg"
    },
    repair: {
      label: "DND5E.FACILITY.Orders.repair.inf",
      icon: "systems/wuxia-system/icons/svg/facilities/repair.svg",
      hidden: true
    },
    research: {
      label: "DND5E.FACILITY.Orders.research.inf",
      icon: "systems/wuxia-system/icons/svg/facilities/research.svg"
    },
    trade: {
      label: "DND5E.FACILITY.Orders.trade.inf",
      icon: "systems/wuxia-system/icons/svg/facilities/trade.svg"
    }
  },
  sizes: {
    cramped: {
...
DND5E.itemProperties = {
  ...
  concentration: {
    ...
    icon: "systems/wuxia-system/icons/svg/statuses/concentrating.svg",
  ...
  mgc: {
    ...
    icon: "systems/wuxia-system/icons/svg/properties/magical.svg",
    isPhysical: true
  },
  rch: {
  ...
  ritual: {
    ...
    icon: "systems/wuxia-system/icons/svg/items/spell.svg",
...
DND5E.currencies = {
  yen: {
    ...
    abbreviation: "¥",
    conversion: 1,
    icon: "systems/wuxia-system/icons/currency/gold.webp"
  }
};
...
DND5E.damageTypes = {
  acid: {
    ...
    icon: "systems/wuxia-system/icons/svg/damage/acid.svg",
  ...
  bludgeoning: {
    ...
    icon: "systems/wuxia-system/icons/svg/damage/bludgeoning.svg",
    isPhysical: true,
  ...
  cold: {
    ...
    icon: "systems/wuxia-system/icons/svg/damage/cold.svg",
    reference: "Compendium.dnd5e.rules.JournalEntry.NizgRXLNUqtdlC1s.JournalEntryPage.4xsFUooHDEdfhw6g",
    color: new Color(0xADD8E6)
  },
  // ── Wuxia Legacy: Corrosão (dado pela Escuridão e por fontes corrosivas) ──
  corrosion: {
    label: "DND5E.DAMAGE.Type.Corrosion",
    icon: "systems/wuxia-system/icons/svg/damage/corrosion.svg",
    color: new Color(0x5A7D3A)
  },
  fire: {
    label: "DND5E.DAMAGE.Type.Fire",
    icon: "systems/wuxia-system/icons/svg/damage/fire.svg",
  ...
  lightning: {
    ...
    icon: "systems/wuxia-system/icons/svg/damage/lightning.svg",
  ...
  piercing: {
    ...
    icon: "systems/wuxia-system/icons/svg/damage/piercing.svg",
    isPhysical: true,
  ...
  poison: {
    ...
    icon: "systems/wuxia-system/icons/svg/damage/poison.svg",
  ...
  psychic: {
    ...
    icon: "systems/wuxia-system/icons/svg/damage/psychic.svg",
  ...
  radiant: {
    ...
    icon: "systems/wuxia-system/icons/svg/damage/radiant.svg",
  ...
  slashing: {
    ...
    icon: "systems/wuxia-system/icons/svg/damage/slashing.svg",
    isPhysical: true,
    reference: "Compendium.dnd5e.rules.JournalEntry.NizgRXLNUqtdlC1s.JournalEntryPage.sz2XKQ5lgsdPEJOa",
    color: new Color(0x8B0000)
  },
  // ── Wuxia Legacy: dano na Alma (acerta diretamente a alma do alvo) ──
  soul: {
    label: "DND5E.DAMAGE.Type.Soul",
    icon: "systems/wuxia-system/icons/svg/damage/soul.svg",
    color: new Color(0x9370DB)
  },
  thunder: {
    label: "DND5E.DAMAGE.Type.Thunder",
    icon: "systems/wuxia-system/icons/svg/damage/thunder.svg",
...
DND5E.encumbrance = {
  ...
  effects: {
    encumbered: {
      ...
      img: "systems/wuxia-system/icons/svg/statuses/encumbered.svg"
    },
    heavilyEncumbered: {
      name: "EFFECT.DND5E.StatusHeavilyEncumbered",
      img: "systems/wuxia-system/icons/svg/statuses/heavily-encumbered.svg"
    },
    exceedingCarryingCapacity: {
      name: "EFFECT.DND5E.StatusExceedingCarryingCapacity",
      img: "systems/wuxia-system/icons/svg/statuses/exceeding-carrying-capacity.svg"
    }
  },
  threshold: {
    encumbered: {
...
DND5E.spellcasting = {
  ...
  spell: {
    ...
    prepares: true,
    order: 20,
    img: "systems/wuxia-system/icons/spell-tiers/{id}.webp",
...
DND5E.spellSchools = {
  abj: {
    ...
    icon: "systems/wuxia-system/icons/svg/schools/abjuration.svg",
    fullKey: "abjuration",
  ...
  con: {
    ...
    icon: "systems/wuxia-system/icons/svg/schools/conjuration.svg",
    fullKey: "conjuration",
  ...
  div: {
    ...
    icon: "systems/wuxia-system/icons/svg/schools/divination.svg",
    fullKey: "divination",
  ...
  enc: {
    ...
    icon: "systems/wuxia-system/icons/svg/schools/enchantment.svg",
    fullKey: "enchantment",
  ...
  evo: {
    ...
    icon: "systems/wuxia-system/icons/svg/schools/evocation.svg",
    fullKey: "evocation",
  ...
  ill: {
    ...
    icon: "systems/wuxia-system/icons/svg/schools/illusion.svg",
    fullKey: "illusion",
  ...
  nec: {
    ...
    icon: "systems/wuxia-system/icons/svg/schools/necromancy.svg",
    fullKey: "necromancy",
  ...
  trs: {
    ...
    icon: "systems/wuxia-system/icons/svg/schools/transmutation.svg",
...
DND5E.conditionTypes = {
  bleeding: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/bleeding.svg",
    pseudo: true
  },
  blinded: {
    name: "DND5E.ConBlinded",
    img: "systems/wuxia-system/icons/svg/statuses/blinded.svg",
  ...
  burning: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/burning.svg",
  ...
  charmed: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/charmed.svg",
  ...
  cursed: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/cursed.svg",
    pseudo: true
  },
  dehydration: {
    name: "EFFECT.DND5E.StatusDehydration",
    img: "systems/wuxia-system/icons/svg/statuses/dehydration.svg",
  ...
  deafened: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/deafened.svg",
  ...
  falling: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/falling.svg",
  ...
  frightened: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/frightened.svg",
  ...
  grappled: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/grappled.svg",
  ...
  incapacitated: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/incapacitated.svg",
  ...
  invisible: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/invisible.svg",
  ...
  malnutrition: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/malnutrition.svg",
  ...
  paralyzed: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/paralyzed.svg",
  ...
  petrified: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/petrified.svg",
  ...
  poisoned: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/poisoned.svg",
    reference: "Compendium.dnd5e.content24.JournalEntry.phbAppendixCRule.JournalEntryPage.HWs8kEojffqwTSJz"
  },
  prone: {
    name: "DND5E.ConProne",
    img: "systems/wuxia-system/icons/svg/statuses/prone.svg",
  ...
  restrained: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/restrained.svg",
  ...
  silenced: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/silenced.svg",
    pseudo: true
  },
  stunned: {
    name: "DND5E.ConStunned",
    img: "systems/wuxia-system/icons/svg/statuses/stunned.svg",
  ...
  suffocation: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/suffocation.svg",
  ...
  surprised: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/surprised.svg",
    pseudo: true
  },
  transformed: {
    name: "EFFECT.DND5E.StatusTransformed",
    img: "systems/wuxia-system/icons/svg/statuses/transformed.svg",
    pseudo: true
  },
  unconscious: {
    name: "DND5E.ConUnconscious",
    img: "systems/wuxia-system/icons/svg/statuses/unconscious.svg",
...
DND5E.statusEffects = {
  burrowing: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/burrowing.svg",
    special: "BURROW"
  },
  concentrating: {
    name: "EFFECT.DND5E.StatusConcentrating",
    img: "systems/wuxia-system/icons/svg/statuses/concentrating.svg",
    special: "CONCENTRATING"
  },
  coverHalf: {
    name: "EFFECT.DND5E.StatusHalfCover",
    img: "systems/wuxia-system/icons/svg/statuses/cover-half.svg",
    order: 2,
  ...
  coverThreeQuarters: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/cover-three-quarters.svg",
    order: 3,
    exclusiveGroup: "cover",
    coverBonus: 5
  },
  coverTotal: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/cover-total.svg",
    order: 4,
    exclusiveGroup: "cover"
  },
  dead: {
    name: "EFFECT.DND5E.StatusDead",
    img: "systems/wuxia-system/icons/svg/statuses/dead.svg",
    special: "DEFEATED",
    order: 1,
    neverBlockMovement: true
  },
  dodging: {
    ...
    img: "systems/wuxia-system/icons/svg/statuses/dodging.svg"
  },
  ethereal: {
    name: "EFFECT.DND5E.StatusEthereal",
    img: "systems/wuxia-system/icons/svg/statuses/ethereal.svg",
    neverBlockMovement: true
  },
  flying: {
    name: "EFFECT.DND5E.StatusFlying",
    img: "systems/wuxia-system/icons/svg/statuses/flying.svg",
    special: "FLY"
  },
  hiding: {
    name: "EFFECT.DND5E.StatusHiding",
    img: "systems/wuxia-system/icons/svg/statuses/hiding.svg"
  },
  hovering: {
    name: "EFFECT.DND5E.StatusHovering",
    img: "systems/wuxia-system/icons/svg/statuses/hovering.svg",
    special: "HOVER"
  },
  marked: {
    name: "EFFECT.DND5E.StatusMarked",
    img: "systems/wuxia-system/icons/svg/statuses/marked.svg"
  },
  sleeping: {
    name: "EFFECT.DND5E.StatusSleeping",
    img: "systems/wuxia-system/icons/svg/statuses/sleeping.svg",
    statuses: ["incapacitated", "unconscious"]
  },
  stable: {
    name: "EFFECT.DND5E.StatusStable",
    img: "systems/wuxia-system/icons/svg/statuses/stable.svg"
  }
};
...
DND5E.bloodied = {
  ...
  img: "systems/wuxia-system/icons/svg/statuses/bloodied.svg",
  threshold: .5
};
...
DND5E.traits = {
  ...
  di: {
    ...
    icon: "systems/wuxia-system/icons/svg/trait-damage-immunities.svg",
  ...
  dr: {
    ...
    icon: "systems/wuxia-system/icons/svg/trait-damage-resistances.svg",
    configKey: "damageTypes"
  },
  dv: {
    labels: {
    ...
    icon: "systems/wuxia-system/icons/svg/trait-damage-vulnerabilities.svg",
    configKey: "damageTypes"
  },
  dm: {
    labels: {
  ...
  ci: {
    ...
    icon: "systems/wuxia-system/icons/svg/trait-condition-immunities.svg",
...
DND5E.defaultArtwork = {
  ActiveEffect: {
    base: "systems/wuxia-system/icons/svg/active-effects/base.svg",
    enchantment: "systems/wuxia-system/icons/svg/active-effects/enchantment.svg"
  },
  Actor: {
    character: "systems/wuxia-system/icons/svg/actors/character.svg",
    encounter: "systems/wuxia-system/icons/svg/actors/encounter.svg",
    group: "systems/wuxia-system/icons/svg/actors/group.svg",
    npc: "systems/wuxia-system/icons/svg/actors/npc.svg",
    vehicle: "systems/wuxia-system/icons/svg/actors/vehicle.svg"
  },
  Item: {
    background: "systems/wuxia-system/icons/svg/items/background.svg",
    class: "systems/wuxia-system/icons/svg/items/class.svg",
    consumable: "systems/wuxia-system/icons/svg/items/consumable.svg",
    container: "systems/wuxia-system/icons/svg/items/container.svg",
    equipment: "systems/wuxia-system/icons/svg/items/equipment.svg",
    facility: "systems/wuxia-system/icons/svg/items/facility.svg",
    feat: "systems/wuxia-system/icons/svg/items/feature.svg",
    loot: "systems/wuxia-system/icons/svg/items/loot.svg",
    race: "systems/wuxia-system/icons/svg/items/race.svg",
    spell: "systems/wuxia-system/icons/svg/items/spell.svg",
    subclass: "systems/wuxia-system/icons/svg/items/subclass.svg",
    tool: "systems/wuxia-system/icons/svg/items/tool.svg",
    weapon: "systems/wuxia-system/icons/svg/items/weapon.svg"
  }
};
