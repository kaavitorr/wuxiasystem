...
export default class ContainerSheet extends ItemSheet5e {
  ...
  static PARTS = {
    ...super.PARTS,
    contents: {
      template: "systems/wuxia-system/templates/items/contents.hbs",
      templates: [
        "systems/wuxia-system/templates/inventory/inventory.hbs", "systems/wuxia-system/templates/inventory/encumbrance.hbs"
      ],
      scrollable: [""]
    }
  };
