...
export default class TransformDialog extends Dialog5e {
  ...
  static PARTS = {
    details: {
      template: "systems/wuxia-system/templates/apps/transform-details.hbs"
    },
    presets: {
      container: { id: "settings-area" },
      template: "systems/wuxia-system/templates/apps/transform-presets.hbs"
    },
    settings: {
      container: { id: "settings-area" },
      template: "systems/wuxia-system/templates/apps/transform-settings.hbs"
    },
    footer: {
