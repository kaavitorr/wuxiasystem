...
export default class VehicleActorSheet extends BaseActorSheet {
  ...
  static PARTS = {
    ...
    sidebar: {
      template: "systems/wuxia-system/templates/actors/vehicle/sidebar.hbs",
      templates: [
        "systems/wuxia-system/templates/actors/parts/actor-trait-line.hbs",
        "systems/wuxia-system/templates/actors/parts/actor-trait-pills.hbs"
      ],
      scrollable: [""]
    },
    stations: {
      template: "systems/wuxia-system/templates/actors/vehicle/stations.hbs",
    ...
    inventory: {
      ...
      templates: [
        ...
        "systems/wuxia-system/templates/inventory/containers.hbs", "systems/wuxia-system/templates/inventory/encumbrance.hbs"
      ],
      scrollable: [""]
    },
    crew: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/wuxia-system/templates/actors/vehicle/crew.hbs",
      scrollable: [""]
    },
    effects: {
      container: { classes: ["tab-body"], id: "tabs" },
    ...
    description: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/wuxia-system/templates/actors/vehicle/description.hbs",
      scrollable: [""]
    }
  };
  ...
  /** @override */
  static TABS = [
    { tab: "inventory", label: "DND5E.VEHICLE.Tabs.Cargo", svg: "systems/wuxia-system/icons/svg/backpack.svg" },
  ...
  async _prepareContext(options) {
    ...
    context.options = {
      showAbilities: this.actor.getFlag("wuxia-system", "showVehicleAbilities"),
      showInitiative: this.actor.getFlag("wuxia-system", "showVehicleInitiative"),
      showQuality: this.actor.getFlag("wuxia-system", "showVehicleQuality")
    };
    return context;
  }
  ...
  async _prepareDraftAnimals() {
    ...
    const unitSystem = game.settings.get("wuxia-system", "metricWeightUnits") ? "metric" : "imperial";
  ...
  async _onRender(context, options) {
    ...
    const hasStations = context.editable
      ...
      || this.actor.getFlag("wuxia-system", "showVehicleAbilities");
