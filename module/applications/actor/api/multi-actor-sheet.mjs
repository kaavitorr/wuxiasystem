...
export default class MultiActorSheet extends BaseActorSheet {
  ...
  async _prepareMemberPortrait(actor, context) {
    const showTokenPortrait = this.actor.getFlag("wuxia-system", "showTokenPortrait");
  ...
  static addDocumentSheetConfigOptions(app, html) {
    ...
    const showTokenPortrait = doc.getFlag("wuxia-system", "showTokenPortrait");
    const artOptions = {
    ...
    fieldset.innerHTML = `
      ...
      <div class="form-group">
        ...
        <div class="form-fields">
          <select name="flags.wuxia-system.showTokenPortrait" data-dtype="Boolean">
