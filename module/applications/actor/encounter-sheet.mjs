...
export default class EncounterActorSheet extends MultiActorSheet {
  ...
  static PARTS = {
    header: {
      template: "systems/wuxia-system/templates/actors/encounter/header.hbs"
    },
    tabs: {
    ...
    members: {
      ...
      template: "systems/wuxia-system/templates/actors/encounter/members.hbs",
      scrollable: [""]
    },
    inventory: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/wuxia-system/templates/actors/tabs/actor-inventory.hbs",
      templates: ["systems/wuxia-system/templates/inventory/inventory.hbs"],
      scrollable: [""]
    },
    description: {
      container: { classes: ["tab-body"], id: "tabs" },
  ...
  static async #onAward() {
    new Award({
      award: {
        ...
        savedDestinations: this.actor.getFlag("wuxia-system", "awardDestinations"),
