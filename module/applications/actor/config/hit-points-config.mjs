...
export default class HitPointsConfig extends BaseConfigSheet {
  ...
  static PARTS = {
    config: {
      template: "systems/wuxia-system/templates/actors/config/hit-points-config.hbs"
    }
  };
  ...
  async _preparePartContext(partId, context, options) {
    ...
    // Wuxia Legacy: Feridas — campo editável na config de HP.
    context.woundsValue = this.document.system._source.attributes?.wounds ?? 0;
