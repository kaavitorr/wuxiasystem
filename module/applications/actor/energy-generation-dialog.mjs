...
import { nivelCultivoDoAtor } from "../../systems/cultivation-data.mjs";
...
export default class EnergyGenerationDialog extends Dialog5e {
  ...
  static PARTS = {
    ...super.PARTS,
    content: {
      template: "systems/wuxia-system/templates/actors/energy-generation-dialog.hbs"
    }
  };
  ...
  /** @override */
  get title() {
    return `Geração de Qi — ${this.actor?.name ?? ""}`;
  }
  ...
  async _prepareContext(options) {
    ...
    // Nível de Cultivo (rank+estágio), não o nível de classe — é ele que rege a geração de Qi.
