...
export default class CompendiumBrowser extends Application5e {
  ...
  static PARTS = {
    header: {
      id: "header",
      classes: ["header"],
      template: "systems/wuxia-system/templates/compendium/browser-header.hbs"
    },
    search: {
      id: "sidebar-search",
      classes: ["filter-element"],
      container: { id: "sidebar", classes: ["sidebar", "flexcol"] },
      template: "systems/wuxia-system/templates/compendium/browser-sidebar-search.hbs"
    },
    types: {
      id: "sidebar-types",
      container: { id: "sidebar", classes: ["sidebar", "flexcol"] },
      template: "systems/wuxia-system/templates/compendium/browser-sidebar-types.hbs"
    },
    filters: {
      id: "sidebar-filters",
      container: { id: "sidebar", classes: ["sidebar", "flexcol"] },
      template: "systems/wuxia-system/templates/compendium/browser-sidebar-filters.hbs",
      templates: ["systems/wuxia-system/templates/compendium/browser-sidebar-filter-set.hbs"]
    },
    results: {
      id: "results",
      classes: ["results"],
      template: "systems/wuxia-system/templates/compendium/browser-results.hbs",
      templates: ["systems/wuxia-system/templates/compendium/browser-entry.hbs"],
      scrollable: [""]
    },
    footer: {
      id: "footer",
      classes: ["footer"],
      template: "systems/wuxia-system/templates/compendium/browser-footer.hbs"
    },
    tabs: {
      id: "tabs",
      classes: ["tabs", "tabs-left"],
      template: "systems/wuxia-system/templates/compendium/browser-tabs.hbs"
    }
  };
  ...
  static TABS = [
    {
      ...
      svg: "systems/wuxia-system/icons/svg/items/class.svg",
      documentClass: "Item",
      types: ["class"]
    },
    {
      ...
      svg: "systems/wuxia-system/icons/svg/items/subclass.svg",
      documentClass: "Item",
      types: ["subclass"]
    },
    {
      ...
      svg: "systems/wuxia-system/icons/svg/items/race.svg",
      documentClass: "Item",
      types: ["race"]
    },
    {
    ...
    },
    {
      ...
      svg: "systems/wuxia-system/icons/svg/items/background.svg",
      documentClass: "Item",
      types: ["background"]
    },
    {
      ...
      svg: "systems/wuxia-system/icons/svg/backpack.svg",
      documentClass: "Item",
      types: ["physical"]
    },
    {
    ...
    },
    {
      ...
      svg: "systems/wuxia-system/icons/svg/actors/npc.svg",
      documentClass: "Actor",
      types: ["npc"]
    },
    {
      ...
      svg: "systems/wuxia-system/icons/svg/actors/vehicle.svg",
      documentClass: "Actor",
      types: ["vehicle"]
    },
    {
  ...
  async _renderResult(entry, documentClass) {
    ...
    const html = await foundry.applications.handlebars.renderTemplate(
      "systems/wuxia-system/templates/compendium/browser-entry.hbs", context
    );
  ...
  async _renderSourceFilters() {
    ...
    const filter = await foundry.applications.handlebars.renderTemplate(
      "systems/wuxia-system/templates/compendium/browser-sidebar-filter-set.hbs",
      {
        locked,
