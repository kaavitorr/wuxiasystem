...
export default class ItemGrantConfig extends AdvancementConfig {
  ...
  static PARTS = {
    ...super.PARTS,
    details: {
      template: "systems/wuxia-system/templates/advancement/item-grant-config-details.hbs"
    },
    spellConfig: {
      template: "systems/wuxia-system/templates/advancement/advancement-spell-config-section.hbs"
    },
    items: {
      template: "systems/wuxia-system/templates/advancement/item-grant-config-items.hbs"
    }
  };
