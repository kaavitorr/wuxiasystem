...
export default class AdvancementFlow extends Application5e {
  ...
  static PARTS = {
    header: {
      template: "systems/wuxia-system/templates/advancement/advancement-flow-header.hbs"
    },
    content: {
      template: "systems/wuxia-system/templates/advancement/advancement-flow-summary.hbs"
    }
  };
