...
export default class AbilityScoreImprovementConfig extends AdvancementConfig {
  ...
  static PARTS = {
    ...super.PARTS,
    details: {
      template: "systems/wuxia-system/templates/advancement/ability-score-improvement-config-details.hbs"
    },
    scores: {
      template: "systems/wuxia-system/templates/advancement/ability-score-improvement-config-scores.hbs",
      templates: ["systems/wuxia-system/templates/advancement/parts/advancement-ability-score-control.hbs"]
    }
  };
