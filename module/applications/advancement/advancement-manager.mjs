...
export default class AdvancementManager extends Application5e {
  ...
  static PARTS = {
    manager: {
      template: "systems/wuxia-system/templates/advancement/advancement-manager.hbs"
    }
  };
...
class AdvancementVisualizer extends Application5e {
  ...
  static PARTS = {
    steps: {
      template: "systems/wuxia-system/templates/advancement/advancement-visualizer.hbs"
    }
  };
