...
export default class CompendiumBrowserSettingsConfig extends Application5e {
  ...
  static PARTS = {
    sidebar: {
      id: "sidebar",
      template: "systems/wuxia-system/templates/compendium/sources-sidebar.hbs"
    },
    packs: {
      id: "packs",
      template: "systems/wuxia-system/templates/compendium/sources-packs.hbs"
    }
  };
  ...
  async _onToggleSource(target) {
    ...
    const setting = { ...game.settings.get("wuxia-system", "packSourceConfiguration"), ...packs };
    await game.settings.set("wuxia-system", "packSourceConfiguration", setting);
    this.render();
  }
  ...
  static collateSources() {
    ...
    const setting = game.settings.get("wuxia-system", "packSourceConfiguration");
