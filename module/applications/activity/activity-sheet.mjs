...
export default class ActivitySheet extends PseudoDocumentSheet {
  ...
  static PARTS = {
    ...
    identity: {
      template: "systems/wuxia-system/templates/activity/identity.hbs",
      templates: [
        "systems/wuxia-system/templates/activity/parts/activity-identity.hbs",
        "systems/wuxia-system/templates/activity/parts/activity-visibility.hbs"
      ]
    },
    activation: {
      template: "systems/wuxia-system/templates/activity/activation.hbs",
      templates: [
        "systems/wuxia-system/templates/activity/parts/activity-time.hbs",
        "systems/wuxia-system/templates/activity/parts/activity-targeting.hbs",
        "systems/wuxia-system/templates/activity/parts/activity-consumption.hbs"
      ]
    },
    effect: {
      template: "systems/wuxia-system/templates/activity/effect.hbs",
      templates: [
        "systems/wuxia-system/templates/activity/parts/activity-effects.hbs",
        "systems/wuxia-system/templates/activity/parts/activity-effect-level-limit.hbs",
        "systems/wuxia-system/templates/activity/parts/activity-effect-settings.hbs",
        "systems/wuxia-system/templates/activity/parts/jj-scale.hbs",
        "systems/wuxia-system/templates/activity/parts/constant-cost.hbs",
        "systems/wuxia-system/templates/activity/parts/condicao.hbs"
      ]
    }
  };
    ...
    if ( context.activity.effects ) {
      ...
      context.appliedEffects = context.activity.effects.reduce((arr, data) => {
        ...
        const effect = {
          ...
          additionalSettings: "systems/wuxia-system/templates/activity/parts/activity-effect-settings.hbs"
        };
