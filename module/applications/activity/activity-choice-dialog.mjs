...
export default class ActivityChoiceDialog extends Application5e {
  ...
  static PARTS = {
    activities: {
      template: "systems/wuxia-system/templates/activity/activity-choices.hbs"
    }
  };
  ...
  async _prepareContext(options) {
    let controlHint;
    if ( game.settings.get("wuxia-system", "controlHints") ) {
      controlHint = game.i18n.localize("DND5E.Controls.Activity.FastForwardHint");
      controlHint = controlHint.replace(
        "<left-click>",
        `<img src="systems/wuxia-system/icons/svg/mouse-left.svg" alt="${game.i18n.localize("DND5E.Controls.LeftClick")}">`
      );
    }
