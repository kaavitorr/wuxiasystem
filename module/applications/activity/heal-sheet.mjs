...
export default class HealSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    effect: {
      template: "systems/wuxia-system/templates/activity/heal-effect.hbs",
      templates: [
        ...super.PARTS.effect.templates,
        "systems/wuxia-system/templates/activity/parts/damage-part.hbs",
        "systems/wuxia-system/templates/activity/parts/heal-healing.hbs",
        "systems/wuxia-system/templates/activity/parts/heal-limit.hbs",
