...
export default class TransformSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    effect: {
      template: "systems/wuxia-system/templates/activity/transform-effect.hbs",
      templates: [
        ...super.PARTS.effect.templates,
        "systems/wuxia-system/templates/activity/parts/transform-profiles.hbs",
        "systems/wuxia-system/templates/activity/parts/transform-settings.hbs"
      ]
    }
  };
