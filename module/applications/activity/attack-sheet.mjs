...
export default class AttackSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    identity: {
      template: "systems/wuxia-system/templates/activity/attack-identity.hbs",
      templates: [
        ...super.PARTS.identity.templates,
        "systems/wuxia-system/templates/activity/parts/attack-identity.hbs"
      ]
    },
    effect: {
      template: "systems/wuxia-system/templates/activity/attack-effect.hbs",
      templates: [
        ...super.PARTS.effect.templates,
        "systems/wuxia-system/templates/activity/parts/attack-damage.hbs",
        "systems/wuxia-system/templates/activity/parts/attack-details.hbs",
