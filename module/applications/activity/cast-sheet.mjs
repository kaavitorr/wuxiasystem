...
export default class CastSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    effect: {
      template: "systems/wuxia-system/templates/activity/cast-effect.hbs",
      templates: [
        "systems/wuxia-system/templates/activity/parts/cast-spell.hbs",
        "systems/wuxia-system/templates/activity/parts/cast-details.hbs"
      ]
    }
  };
