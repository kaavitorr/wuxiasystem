...
export default class EnchantSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    effect: {
      template: "systems/wuxia-system/templates/activity/enchant-effect.hbs",
      templates: [
        "systems/wuxia-system/templates/activity/parts/enchant-enchantments.hbs",
        "systems/wuxia-system/templates/activity/parts/enchant-restrictions.hbs"
      ]
    }
  };
