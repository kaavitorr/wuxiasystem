...
export default class SummonSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    effect: {
      template: "systems/wuxia-system/templates/activity/summon-effect.hbs",
      templates: [
        ...super.PARTS.effect.templates,
        "systems/wuxia-system/templates/activity/parts/summon-changes.hbs",
        "systems/wuxia-system/templates/activity/parts/summon-profiles.hbs"
      ]
    }
  };
