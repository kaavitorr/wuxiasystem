...
export default class BaseHealActivityData extends BaseActivityData {
  ...
  static defineSchema() {
    return {
      ...
      // Limite TOTAL de cura desta atividade. A cura é capada ao saldo restante
      // e o consumo é registrado em `spent`. Reseta conforme `reset`.
      healLimit: new SchemaField({
        ...
        formula: new FormulaField({ deterministic: true, label: "Limite Total de Cura" }),
