...
export default class WeaponData extends ItemDataModel.mixin(
  ...
  get attackModes() {
    ...
    const isLight = this.properties.has("lgt") || (this.parent.actor?.getFlag("wuxia-system", "enhancedDualWielding")
  ...
  get proficiencyMultiplier() {
    ...
    const improvised = (this.type.value === "improv") && !!actor.getFlag("wuxia-system", "tavernBrawlerFeat");
