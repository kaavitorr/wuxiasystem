...
export function areKeysPressed(event, action) {
  ...
  return game.keybindings.get("wuxia-system", action).some(b => {
...
export function defaultUnits(type) {
  ...
  return CONFIG.DND5E.defaultUnits[type]?.[game.settings.get("wuxia-system", settingKey) ? "metric" : "imperial"];
}
...
export async function preloadHandlebarsTemplates() {
  const partials = [
    // Shared Partials
    "systems/wuxia-system/templates/shared/active-effects.hbs",
    "systems/wuxia-system/templates/apps/parts/trait-list.hbs",
    "systems/wuxia-system/templates/apps/parts/traits-list.hbs",

    // Actor Sheet Partials
    "systems/wuxia-system/templates/actors/parts/actor-classes.hbs",
    "systems/wuxia-system/templates/actors/parts/actor-trait-pills.hbs",
    "systems/wuxia-system/templates/actors/parts/actor-traits.hbs",
    "systems/wuxia-system/templates/actors/parts/actor-features.hbs",
    "systems/wuxia-system/templates/actors/parts/actor-spellbook.hbs",
    "systems/wuxia-system/templates/actors/parts/actor-warnings.hbs",
    "systems/wuxia-system/templates/actors/parts/actor-warnings-dialog.hbs",
    "systems/wuxia-system/templates/actors/parts/biography-textbox.hbs",
    "systems/wuxia-system/templates/actors/parts/jj-power-buttons.hbs",
    "systems/wuxia-system/templates/actors/tabs/character-bastion.hbs",
    "systems/wuxia-system/templates/actors/tabs/character-biography.hbs",
    "systems/wuxia-system/templates/actors/tabs/character-details.hbs",
    "systems/wuxia-system/templates/actors/tabs/creature-special-traits.hbs",
    "systems/wuxia-system/templates/actors/tabs/npc-biography.hbs",

    // Chat Message Partials
    "systems/wuxia-system/templates/chat/parts/card-activities.hbs",
    "systems/wuxia-system/templates/chat/parts/card-deltas.hbs",

    // Item Sheet Partials
    "systems/wuxia-system/templates/items/details/details-background.hbs",
    "systems/wuxia-system/templates/items/details/details-class.hbs",
    "systems/wuxia-system/templates/items/details/details-consumable.hbs",
    "systems/wuxia-system/templates/items/details/details-container.hbs",
    "systems/wuxia-system/templates/items/details/details-equipment.hbs",
    "systems/wuxia-system/templates/items/details/details-facility.hbs",
    "systems/wuxia-system/templates/items/details/details-feat.hbs",
    "systems/wuxia-system/templates/items/details/details-loot.hbs",
    "systems/wuxia-system/templates/items/details/details-mountable.hbs",
    "systems/wuxia-system/templates/items/details/details-species.hbs",
    "systems/wuxia-system/templates/items/details/details-spell.hbs",
    "systems/wuxia-system/templates/items/details/details-spellcasting.hbs",
    "systems/wuxia-system/templates/items/details/details-starting-equipment.hbs",
    "systems/wuxia-system/templates/items/details/details-subclass.hbs",
    "systems/wuxia-system/templates/items/details/details-tool.hbs",
    "systems/wuxia-system/templates/items/details/details-weapon.hbs",
    "systems/wuxia-system/templates/items/parts/item-summary.hbs",
    "systems/wuxia-system/templates/items/parts/item-tooltip.hbs",
    "systems/wuxia-system/templates/items/parts/spell-block.hbs",

    // Field Partials
    "systems/wuxia-system/templates/shared/fields/field-activation.hbs",
    "systems/wuxia-system/templates/shared/fields/field-damage.hbs",
    "systems/wuxia-system/templates/shared/fields/field-duration.hbs",
    "systems/wuxia-system/templates/shared/fields/field-range.hbs",
    "systems/wuxia-system/templates/shared/fields/field-targets.hbs",
    "systems/wuxia-system/templates/shared/fields/field-uses.hbs",
    "systems/wuxia-system/templates/shared/fields/fieldlist.hbs",
    "systems/wuxia-system/templates/shared/fields/formlist.hbs",

    // Journal Partials
    "systems/wuxia-system/templates/journal/parts/journal-legacy-traits.hbs",
    "systems/wuxia-system/templates/journal/parts/journal-modern-traits.hbs",
    "systems/wuxia-system/templates/journal/parts/journal-table.hbs",

    // Activity Partials
    "systems/wuxia-system/templates/activity/parts/activity-usage-notes.hbs",

    // Advancement Partials
    "systems/wuxia-system/templates/advancement/parts/advancement-controls.hbs",
    "systems/wuxia-system/templates/advancement/parts/advancement-spell-config.hbs"
  ];
